        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="space-y-4">
            ...
            <div className="flex space-x-4">
              <Link href="https://facebook.com/minirecipee" className="text-muted-foreground hover:text-primary transition-colors">
                <Facebook className="h-5 w-5" />
              </Link>
              <Link href="https://www.pinterest.com/minirecipe_/#" className="text-muted-foreground hover:text-primary transition-colors">
