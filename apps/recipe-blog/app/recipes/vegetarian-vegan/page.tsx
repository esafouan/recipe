...
const categoryConfig = getCategoryRecipesConfig("vegetarian-vegan")
...
export default function VegetarianVeganRecipesPage() {
  return (
    <CategoryPage category="vegetarian-vegan" />
  )
}
