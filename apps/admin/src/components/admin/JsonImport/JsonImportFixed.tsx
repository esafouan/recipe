      ...
      <div className="mt-4 p-3 bg-blue-50 rounded-lg">
        <div className="flex items-start space-x-2">
          ...
          <div className="text-xs text-blue-700">
            <p className="font-medium mb-1">JSON Format Example:</p>
            <p className="text-blue-600">Download the template below or check the documentation for the required fields.</p>
          </div>
        </div>
      </div>
    </div>
